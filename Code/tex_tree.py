def generate_tex_tree(M, save_path):
    ...
    with open(save_path, 'w') as f:
        ...
        f.write(r'\draw[->, thick] ([yshift=5.5cm]h0)   |- (h1_0)  node[above, pos=0.8] {arm $0$};' + '\n')
        f.write(r'\draw[->, thick] ([yshift=-5.5cm]h0)  |- (h1_2)  node[above, pos=0.8] {arm $1$};' + '\n')
        f.write(r'\draw[->, thick] ([yshift=4.0cm]h1_0) |- (h2_0)  node[above, pos=0.8] {arm $0$};' + '\n')
        f.write(r'\draw[->, thick] ([yshift=1.5cm]h1_0) |- (h2_2)  node[above, pos=0.8] {arm $1$};' + '\n')
        f.write(r'\draw[->, thick] ([yshift=1.5cm]h1_0) |- (h2_4)  node[above, pos=0.8] {arm $0$};' + '\n')
        f.write(r'\draw[->, thick] ([yshift=1.5cm]h1_0) |- (h2_6)  node[above, pos=0.8] {arm $1$};' + '\n')
        f.write(r'\draw[->, thick] ([yshift=1.5cm]h1_2) |- (h2_8)  node[above, pos=0.8] {arm $0$};' + '\n')
        f.write(r'\draw[->, thick] ([yshift=1.5cm]h1_2) |- (h2_10) node[above, pos=0.8] {arm $1$};' + '\n')
        f.write(r'\draw[->, thick] ([yshift=1.5cm]h1_2) |- (h2_12) node[above, pos=0.8] {arm $0$};' + '\n')
        f.write(r'\draw[->, thick] ([yshift=1.5cm]h1_2) |- (h2_14) node[above, pos=0.8] {arm $1$};' + '\n')
