...
\node[rectangle, text centered, draw=black, minimum height=1mm, text width=3mm, inner sep=0pt, fill=orange, opacity=0.43] at (-7.00, 6.75) (1_s_0) {};
\node[rectangle, text centered, draw=black, minimum height=1mm, text width=3mm, inner sep=0pt, fill=orange, opacity=0.17] at (-7.00, 6.59) (1_s_1) {};
\node[rectangle, text centered, draw=black, minimum height=1mm, text width=3mm, inner sep=0pt, fill=orange, opacity=0.26] at (-7.00, -6.59) (1_s_2) {};
\node[rectangle, text centered, draw=black, minimum height=1mm, text width=3mm, inner sep=0pt, fill=orange, opacity=0.13] at (-7.00, -6.75) (1_s_3) {};
...
\draw[->, thick, red] (0_s_0) -- (1_b_1) node [near end, above, sloped, font=\tiny] () {\textcolor{blue}{1.56}};
...
\draw[->, thick, red] (1_s_3) -- (2_b_6) node [near start, above, sloped, font=\tiny] () {\textcolor{red}{update}} node [near end, above, sloped, font=\tiny] () {\textcolor{blue}{1.27}};
