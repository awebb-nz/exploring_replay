...
\draw[->, thick, red] (0_s_0) -- (1_b_1) node [near end, above, sloped, font=\tiny] () {\textcolor{blue}{1.81}};
...
\draw[->, thick, red] (1_s_3) -- (2_b_7) node [near start, above, sloped, font=\tiny] () {\textcolor{red}{update}} node [near end, above, sloped, font=\tiny] () {\textcolor{blue}{1.06}};
\end{tikzpicture}
\end{minipage}
