...
\node[rectangle, text centered, draw=black, minimum height=1mm, text width=3mm, inner sep=0pt, fill=orange, opacity=0.39] at (-7.00, 6.75) (1_s_0) {};
\node[rectangle, text centered, draw=black, minimum height=1mm, text width=3mm, inner sep=0pt, fill=orange, opacity=0.16] at (-7.00, 6.59) (1_s_1) {};
\node[rectangle, text centered, draw=black, minimum height=1mm, text width=3mm, inner sep=0pt, fill=orange, opacity=0.30] at (-7.00, -6.59) (1_s_2) {};
\node[rectangle, text centered, draw=black, minimum height=1mm, text width=3mm, inner sep=0pt, fill=orange, opacity=0.15] at (-7.00, -6.75) (1_s_3) {};
...
\draw[->, thick, red] (0_s_0) -- (1_b_1) node [near start, above, sloped, font=\tiny] () {\textcolor{red}{update}} node [near end, above, sloped, font=\tiny] () {\textcolor{blue}{1.86}};
...
\draw[->, thick, red] (1_s_1) -- (2_b_2) node [near end, above, sloped, font=\tiny] () {\textcolor{blue}{1.27}};
\draw[->, thick, red] (1_s_1) -- (2_b_3) node [near end, above, sloped, font=\tiny] () {\textcolor{blue}{1.27}};
\draw[->, thick, red] (1_s_2) -- (2_b_4) node [near end, above, sloped, font=\tiny] () {\textcolor{blue}{1.37}};
\draw[->, thick, red] (1_s_2) -- (2_b_5) node [near end, above, sloped, font=\tiny] () {\textcolor{blue}{1.41}};
\draw[->, thick, red] (1_s_3) -- (2_b_6) node [near end, above, sloped, font=\tiny] () {\textcolor{blue}{1.27}};
\draw[->, thick, red] (1_s_3) -- (2_b_7) node [near end, above, sloped, font=\tiny] () {\textcolor{blue}{1.06}};
\end{tikzpicture}
\end{minipage}
