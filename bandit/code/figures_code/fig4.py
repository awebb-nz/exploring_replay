...
# save path
save_path = '/home/georgy/Documents/Dayan_lab/PhD/bandits/bandit/data/paper_figures/fig4'
...
def main():
    ...
    for idx in range(len(replay_history)):
        ...
        generate_big_tex_tree(tree.horizon, these_replays, qval_history[idx], need_history[idx], this_save_path, height=4)
