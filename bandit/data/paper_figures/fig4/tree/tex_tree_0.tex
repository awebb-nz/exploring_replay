...
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.43, draw opacity=1, text opacity=1] at (-8.40, 2.89) (1_s_0) {\tiny 0.43};
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.02, draw opacity=1, text opacity=1] at (-8.40, 2.45) (1_s_1) {\tiny 0.02};
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.43, draw opacity=1, text opacity=1] at (-8.40, -2.45) (1_s_2) {\tiny 0.43};
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.02, draw opacity=1, text opacity=1] at (-8.40, -2.89) (1_s_3) {\tiny 0.02};
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.18, draw opacity=1, text opacity=1] at (-6.80, 4.22) (2_s_0) {\tiny 0.18};
\node[qval] at (-6.20, 4.22) () {\tiny \textcolor{blue}{0.70}};
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.01, draw opacity=1, text opacity=1] at (-6.80, 3.78) (2_s_1) {\tiny 0.01};
\node[qval] at (-6.20, 3.78) () {\tiny \textcolor{blue}{0.66}};
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.18, draw opacity=1, text opacity=1] at (-6.80, 3.08) (2_s_2) {\tiny 0.18};
\node[qval] at (-6.20, 3.08) () {\tiny \textcolor{blue}{0.70}};
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.01, draw opacity=1, text opacity=1] at (-6.80, 2.64) (2_s_3) {\tiny 0.01};
\node[qval] at (-6.20, 2.64) () {\tiny \textcolor{blue}{0.69}};
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.01, draw opacity=1, text opacity=1] at (-6.80, 1.93) (2_s_4) {\tiny 0.01};
...
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.01, draw opacity=1, text opacity=1] at (-6.80, 0.79) (2_s_6) {\tiny 0.01};
...
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.18, draw opacity=1, text opacity=1] at (-6.80, -0.35) (2_s_8) {\tiny 0.18};
\node[qval] at (-6.20, -0.35) () {\tiny \textcolor{blue}{0.70}};
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.02, draw opacity=1, text opacity=1] at (-6.80, -0.79) (2_s_9) {\tiny 0.02};
\node[qval] at (-6.20, -0.79) () {\tiny \textcolor{blue}{0.66}};
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.18, draw opacity=1, text opacity=1] at (-6.80, -1.49) (2_s_10) {\tiny 0.18};
\node[qval] at (-6.20, -1.49) () {\tiny \textcolor{blue}{0.70}};
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.02, draw opacity=1, text opacity=1] at (-6.80, -1.93) (2_s_11) {\tiny 0.02};
\node[qval] at (-6.20, -1.93) () {\tiny \textcolor{blue}{0.70}};
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.01, draw opacity=1, text opacity=1] at (-6.80, -2.64) (2_s_12) {\tiny 0.01};
\node[qval] at (-6.20, -2.64) () {\tiny \textcolor{blue}{0.69}};
...
\node[rectangle, text centered, draw=black, minimum height=0.2cm, minimum width=0.45cm, fill=orange, fill opacity=0.01, draw opacity=1, text opacity=1] at (-6.80, -3.78) (2_s_14) {\tiny 0.01};
