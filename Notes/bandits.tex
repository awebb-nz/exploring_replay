...
Prioritisation pattern with horizon $h=2$. Numbers under the arrows show the order in which 
the replay updates (red arrows) were executed.
\vspace{1cm}
...
same values as in the above example with shorter horizon. Note that for this tree, EVB 
was not scaled by the probability of reaching any belief.
\vspace{1cm}
