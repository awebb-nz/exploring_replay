...
for idx, p in enumerate(params):
    ...
    plt.savefig(os.path.join('/home/georgy/Documents/Dayan_lab/PhD/bandits/paper/figures/fig1_new/prior_%u.svg'%idx), transparent=True)
    plt.savefig(os.path.join('/home/georgy/Documents/Dayan_lab/PhD/bandits/paper/figures/fig1_new/prior_%u.png'%idx))
    plt.close()
