...
load_path = '/home/georgy/Documents/Dayan_lab/PhD/bandits/paper/figures/supp/supp7'
...
def main():
    ...
    plt.savefig(os.path.join(load_path, 'supp7.png'))
    plt.savefig(os.path.join(load_path, 'supp7.svg'), transparent=True)
