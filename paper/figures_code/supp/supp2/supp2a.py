...
def main():
    ...
    for idx in range(len(replay_history)):
        ...
        generate_big_tex_tree(these_replays, qval_history[idx], need_history[idx], this_save_path, display_need=False, gap=0.10, tree_height=7, state_height=0.14, state_width=0.38, between_height=0.05, between_width=0.5)
