...
load_path = '/home/georgy/Documents/Dayan_lab/PhD/bandits/paper/figures/supp/supp3/data/1/0'
...
def main():
    ...
    plt.savefig(os.path.join(load_path, 'supp3.png'))
    plt.savefig(os.path.join(load_path, 'supp3.svg'), transparent=True)
    plt.close()
