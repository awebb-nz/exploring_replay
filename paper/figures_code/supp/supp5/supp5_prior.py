...
plt.savefig(os.path.join('/home/georgy/Documents/Dayan_lab/PhD/bandits/paper/figures/supp/supp5/prior_opened.svg'), transparent=True)
plt.savefig(os.path.join('/home/georgy/Documents/Dayan_lab/PhD/bandits/paper/figures/supp/supp5/prior_opened.png'))