...
\node[rectangle, text centered, draw=black, minimum height=0.20cm, minimum width=0.45cm, fill=orange, fill opacity=0.07, draw opacity=1, text opacity=1] at (-6.80, 0.82) (2_s_4) {\tiny 0.07};
\node[qval] at (-6.20, 0.82) () {\tiny \textcolor{blue}{5.10}};
\node[rectangle, text centered, draw=black, minimum height=0.20cm, minimum width=0.45cm, fill=orange, fill opacity=0.13, draw opacity=1, text opacity=1] at (-6.80, 0.38) (2_s_5) {\tiny 0.13};
\node[qval] at (-6.20, 0.38) () {\tiny \textcolor{blue}{5.10}};
\node[rectangle, text centered, draw=black, minimum height=0.20cm, minimum width=0.45cm, fill=orange, fill opacity=0.10, draw opacity=1, text opacity=1] at (-6.80, -0.38) (2_s_6) {\tiny 0.10};
\node[qval] at (-6.20, -0.38) () {\tiny \textcolor{blue}{5.10}};
...
\node[qval] at (-6.20, -2.78) () {\tiny \textcolor{blue}{5.10}};
\draw[->, thick, green] (0_s_0.east) -- (1_b_0.west) node [pos=0.35, above=-0.2em, sloped, font=\tiny] () {\textcolor{black}{0}} node [pos=0.80, above=-0.2em, sloped, font=\tiny] () {\textcolor{blue}{3.51}};
