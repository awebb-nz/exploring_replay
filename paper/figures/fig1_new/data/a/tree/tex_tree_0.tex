...
\node[rectangle, text centered, draw=black, minimum height=0.20cm, minimum width=0.45cm, fill=orange, fill opacity=0.23, draw opacity=1, text opacity=1] at (-8.40, 3.22) (1_s_0) {\tiny 0.23};
\node[qval] at (-7.80, 3.22) () {\tiny \textcolor{blue}{6.67}};
\node[rectangle, text centered, draw=black, minimum height=0.20cm, minimum width=0.45cm, fill=orange, fill opacity=0.23, draw opacity=1, text opacity=1] at (-8.40, 2.78) (1_s_1) {\tiny 0.23};
\node[qval] at (-7.80, 2.78) () {\tiny \textcolor{blue}{5.10}};
\node[rectangle, text centered, draw=black, minimum height=0.20cm, minimum width=0.45cm, fill=orange, fill opacity=0.23, draw opacity=1, text opacity=1] at (-8.40, -2.78) (1_s_2) {\tiny 0.23};
\node[qval] at (-7.80, -2.78) () {\tiny \textcolor{blue}{5.10}};
