...
\node[rectangle, text centered, draw=black, minimum height=0.20cm, minimum width=0.45cm, fill=orange, fill opacity=0.21, draw opacity=1, text opacity=1] at (-6.80, -1.92) (2_s_12) {\tiny 0.21};
\node[qval] at (-6.20, -1.92) () {\tiny \textcolor{blue}{5.38}};
\node[rectangle, text centered, draw=black, minimum height=0.20cm, minimum width=0.45cm, fill=orange, fill opacity=0.19, draw opacity=1, text opacity=1] at (-6.80, -2.36) (2_s_13) {\tiny 0.19};
\node[qval] at (-6.20, -2.36) () {\tiny \textcolor{blue}{5.00}};
\node[rectangle, text centered, draw=black, minimum height=0.20cm, minimum width=0.45cm, fill=orange, fill opacity=0.00, draw opacity=1, text opacity=1] at (-6.80, -2.78) (2_s_14) {\tiny 0.00};
\node[qval] at (-6.20, -2.78) () {\tiny \textcolor{blue}{5.20}};
\node[rectangle, text centered, draw=black, minimum height=0.20cm, minimum width=0.45cm, fill=orange, fill opacity=0.00, draw opacity=1, text opacity=1] at (-6.80, -3.22) (2_s_15) {\tiny 0.00};
...
\draw[->, thick, green] (0_s_0.east) -- (1_b_1.west) node [pos=0.35, above=-0.2em, sloped, font=\tiny] () {\textcolor{black}{0}} node [pos=0.80, above=-0.2em, sloped, font=\tiny] () {\textcolor{blue}{5.57}};
...
\draw[->, thick, red] (1_s_3.east) -- (2_b_6.west) node [pos=0.70, above=-0.2em, sloped, font=\tiny] () {\textcolor{blue}{5.20}};
